...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 20 Jun 2021 pada 03.07
...
INSERT INTO `jenis_kasus` (`id_kasus`, `jenis_kasus`) VALUES
(1, 'OTG'),
(2, 'ODP'),
(3, 'PDP'),
(4, 'POSITIF');
...
CREATE TABLE `kabupaten` (
  ...
  `kabupaten` varchar(128) COLLATE latin1_general_ci DEFAULT NULL
...
INSERT INTO `kabupaten` (`kabupaten_id`, `kabupaten`) VALUES
(1, 'ALOR'),
(2, 'BELU'),
(3, 'ENDE'),
(4, 'FLORES TIMUR'),
...
CREATE TABLE `kecamatan` (
  ...
  `kecamatan` varchar(256) COLLATE latin1_general_ci DEFAULT NULL
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COLLATE=latin1_general_ci ROW_FORMAT=DYNAMIC;
...
INSERT INTO `kecamatan` (`kecamatan_id`, `kabupaten_id`, `kecamatan`) VALUES
(1, 1, 'ALOR BARAT DAYA'),
(2, 1, 'ALOR BARAT LAUT'),
(3, 2, 'ALOR SELATAN'),
...
CREATE TABLE `kelurahan` (
  ...
  `kelurahan` varchar(256) COLLATE latin1_general_ci DEFAULT NULL
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COLLATE=latin1_general_ci ROW_FORMAT=DYNAMIC;
...
INSERT INTO `kelurahan` (`kelurahan_id`, `kecamatan_id`, `kelurahan`) VALUES
(1, 1, 'HALERMAN'),
(2, 1, 'KAFELULANG'),
(3, 1, 'KUIFANA'),
(4, 1, 'MANATANG'),
...
--
ALTER TABLE `data_covid`
  MODIFY `id_covid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
